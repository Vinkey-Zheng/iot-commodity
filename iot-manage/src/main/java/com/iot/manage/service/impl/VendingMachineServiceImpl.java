...
import com.iot.common.utils.uuid.UUIDUtils;
...
import com.iot.manage.mapper.VendingMachineMapper;
...
public class VendingMachineServiceImpl implements IVendingMachineService
{
    ...
    public int insertVendingMachine(VendingMachine vendingMachine)
    {
        ...
        //1-4 设备状态
        vendingMachine.setVmStatus(IoTContants.VM_STATUS_NODEPLOY);// 0-表示未投放
