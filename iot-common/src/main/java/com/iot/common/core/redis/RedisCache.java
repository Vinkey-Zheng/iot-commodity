package com.iot.common.core.redis;
...
public class RedisCache
{
    ...
    public void setWithRandomExpire(String key, Object value, long baseTimeout, long randomRange) {
        long expireTime = baseTimeout + (long)(Math.random() * randomRange);
     ...
     * @return 是否获取成功
     */
    public boolean setIfAbsent(String lockKey, String locked, long timeout) {
